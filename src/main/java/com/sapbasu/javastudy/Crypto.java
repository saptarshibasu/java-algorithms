...
public class Crypto {
	...
	private static final List<Integer> ALLOWED_KEY_SIZES = Arrays.asList(new Integer[] { 128, 192, 256 }); // bytes
	private static final String ENCRYPT_ALGO = "AES/GCM/NoPadding";

	private static SecureRandom prng;

	// Used to keep track of random number bytes generated by PRNG (for the purpose
	// of re-seeding)
	...
	public byte[] encrypt(byte[] input, SecretKeySpec key) throws Exception {
		...
		if (!ALLOWED_KEY_SIZES.contains(key.getEncoded().length)) {
